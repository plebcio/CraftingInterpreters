...
// some globals
Compiler* current = NULL;  //bad practice 
...
static void consume(TokenType type, const char* mess){
...
static void forStatement() { 
    ...
    if(!match(TOKEN_SEMICOLON)){
        expression();
        consume(TOKEN_SEMICOLON, "Exprect ';' after loop condition");

        // jump out of the loop if its false
